...
app.use(session({
    store: MongoStore.create({
      mongoUrl: 'mongodb+srv://lucianobenzoni:MiJTnJr8GfXC6t9c@ecommerce.ywkc4sk.mongodb.net/?retryWrites=true&w=majority',
      dbName: 'ecommerce',
      mongoOptions: {
...
try {
    await mongoose.connect('mongodb+srv://lucianobenzoni:MiJTnJr8GfXC6t9c@ecommerce.ywkc4sk.mongodb.net/?retryWrites=true&w=majority') // conecta con la base de datos
